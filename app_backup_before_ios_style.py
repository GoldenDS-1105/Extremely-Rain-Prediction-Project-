...
.risk-card,.summary-box,.app-header,.ground-truth{animation:fadeIn 0.35s ease;}
.stApp{
    background:
...
[data-testid="column"],[data-testid="stColumn"]>div,
...
div[data-testid="stRadio"] label{background:#fffdf5 !important;border:2px solid #d4a017 !important;border-radius:20px !important;padding:8px 20px !important;margin-right:8px !important;cursor:pointer !important;}
div[data-testid="stRadio"] label *{color:#1a1a1a !important;font-weight:700 !important;font-size:1.15rem !important;opacity:1 !important;}
div[data-testid="stRadio"] label:has(input:checked){background:#d4a017 !important;border-color:#d4a017 !important;}
div[data-testid="stRadio"] label:has(input:checked) *{color:#ffffff !important;}
div[data-testid="stRadio"] label:hover:not(:has(input:checked)){background:#fff0b0 !important;}
div[data-testid="stRadio"]>div{display:flex !important;flex-direction:row !important;gap:8px !important;flex-wrap:wrap !important;}
div[data-testid="stRadio"] input{display:none !important;}
div[data-testid="stSelectbox"]>div>div{background:#fffdf5 !important;border:2px solid #e0c890 !important;border-radius:10px !important;}
div[data-testid="stSelectbox"] *{color:#1a1a1a !important;font-size:1.15rem !important;}
div[data-baseweb="select"]>div{background:#fffdf5 !important;color:#1a1a1a !important;}
ul[data-testid="stSelectboxVirtualDropdown"],div[data-baseweb="popover"],div[data-baseweb="menu"]{background:#fffdf5 !important;border:1px solid #e8dfc0 !important;}
ul[data-testid="stSelectboxVirtualDropdown"] li,div[data-baseweb="popover"] li,div[data-baseweb="menu"] li{color:#1a1a1a !important;font-size:1.15rem !important;background:#fffdf5 !important;}
ul[data-testid="stSelectboxVirtualDropdown"] li:hover,div[data-baseweb="popover"] li:hover,div[data-baseweb="menu"] li:hover{background:#fff0c0 !important;}
div[data-testid="stButton"]>button{border-radius:24px !important;font-weight:700 !important;font-size:1.0rem !important;padding:8px 20px !important;border:2px solid #d4a017 !important;background:#fffdf5 !important;color:#6b5510 !important;transition:all 0.2s ease !important;width:100%;}
div[data-testid="stButton"]>button:hover{background:#d4a017 !important;color:#ffffff !important;}
@media(max-width:768px){.app-header{flex-direction:column;align-items:flex-start;gap:8px;padding:12px 16px;}.app-meta{text-align:left;}.prob-number{font-size:3.8rem;}.station-name{font-size:1.5rem;}.sum-grid{flex-wrap:wrap;gap:12px;}}
"""
    else:
        return """
@import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Space+Grotesk:wght@500;600;700&display=swap');
...
div[data-testid="stRadio"] label{background:#f5f9ff !important;border:2px solid #2196f3 !important;border-radius:20px !important;padding:8px 20px !important;margin-right:8px !important;cursor:pointer !important;}
div[data-testid="stRadio"] label *{color:#1a1a1a !important;font-weight:700 !important;font-size:1.15rem !important;opacity:1 !important;}
div[data-testid="stRadio"] label:has(input:checked){background:#1976d2 !important;border-color:#1976d2 !important;}
div[data-testid="stRadio"] label:has(input:checked) *{color:#ffffff !important;}
div[data-testid="stRadio"] label:hover:not(:has(input:checked)){background:#e3f2fd !important;}
div[data-testid="stRadio"]>div{display:flex !important;flex-direction:row !important;gap:8px !important;flex-wrap:wrap !important;}
div[data-testid="stRadio"] input{display:none !important;}
div[data-testid="stSelectbox"]>div>div{background:#f5f9ff !important;border:2px solid #90c4e8 !important;border-radius:10px !important;}
div[data-testid="stSelectbox"] *{color:#1a1a1a !important;font-size:1.15rem !important;}
div[data-baseweb="select"]>div{background:#f5f9ff !important;color:#1a1a1a !important;}
ul[data-testid="stSelectboxVirtualDropdown"],div[data-baseweb="popover"],div[data-baseweb="menu"]{background:#f5f9ff !important;border:1px solid #b8d8f0 !important;}
ul[data-testid="stSelectboxVirtualDropdown"] li,div[data-baseweb="popover"] li,div[data-baseweb="menu"] li{color:#1a1a1a !important;font-size:1.15rem !important;background:#f5f9ff !important;}
ul[data-testid="stSelectboxVirtualDropdown"] li:hover,div[data-baseweb="popover"] li:hover,div[data-baseweb="menu"] li:hover{background:#bbdefb !important;}
div[data-testid="stButton"]>button{border-radius:24px !important;font-weight:700 !important;font-size:1.0rem !important;padding:8px 20px !important;border:2px solid #2196f3 !important;background:#f5f9ff !important;color:#1565c0 !important;transition:all 0.2s ease !important;width:100%;}
div[data-testid="stButton"]>button:hover{background:#1976d2 !important;color:#ffffff !important;}
@media(max-width:768px){.app-header{flex-direction:column;align-items:flex-start;gap:8px;padding:12px 16px;}.app-meta{text-align:left;}.prob-number{font-size:3.8rem;}.station-name{font-size:1.5rem;}.sum-grid{flex-wrap:wrap;gap:12px;}}
"""
...
_, _tcol = st.columns([7, 3])
with _tcol:
    _label = "🌊 Theme Xanh biển" if st.session_state.theme == "gold" else "✨ Theme Vàng trắng"
    if st.button(_label, key="theme_toggle", use_container_width=True):
        st.session_state.theme = "blue" if st.session_state.theme == "gold" else "gold"
        st.rerun()
